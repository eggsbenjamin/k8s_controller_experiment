...
func (in *CassandraClusterSpec) DeepCopyInto(out *CassandraClusterSpec) {
	*out = *in
	if in.Nodes != nil {
		...
		*out = make([]CassandraNodeSpec, len(*in))
		copy(*out, *in)
	}
}
...
func (in *CassandraClusterStatus) DeepCopyInto(out *CassandraClusterStatus) {
	*out = *in
	if in.Nodes != nil {
		in, out := &in.Nodes, &out.Nodes
		*out = make([]CassandraNodeStatus, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CassandraNodeSpec) DeepCopyInto(out *CassandraNodeSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CassandraNodeSpec.
func (in *CassandraNodeSpec) DeepCopy() *CassandraNodeSpec {
	if in == nil {
		return nil
	}
	out := new(CassandraNodeSpec)
	in.DeepCopyInto(out)
	return out
}
